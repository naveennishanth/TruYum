...
public class MenuItemDaoSqlImpl implements MenuItemDao {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.cognizant.truyum.dao.MenuItemDao#modifyMenuItem(com.cognizant.truyum
	 * .model.MenuItem)
	 */
	@Override
			...
			try {
				...
				while (resultSet.next()) {
					...
					if (freeDelivery != null && freeDelivery.equals("Yes"))
						...
						freeDeliveryFlag = false;
					menuItem = new MenuItem(menuItemId, name, price, activeFlag, date_of_launch, category,
							freeDeliveryFlag);
				}
